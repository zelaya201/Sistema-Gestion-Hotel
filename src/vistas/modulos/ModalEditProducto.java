...
public class ModalEditProducto extends javax.swing.JDialog {
    
    
    public ModalEditProducto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void setControlador(Controlador control){
        ...
        this.tfNomP.addKeyListener(control);
