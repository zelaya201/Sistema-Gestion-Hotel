...
//        this.btnVenta.setActionCommand("Productos");
    ...
    private void initComponents() {
        ...
        btnTipoHab1 = new newscomponents.RSButtonIcon_new();
        ...
        btnVenta.setIcons(rojeru_san.efectos.ValoresEnum.ICONS.ARCHIVE);
        ...
        btnTipoHab1.setBackground(new java.awt.Color(51, 65, 80));
        btnTipoHab1.setText("Tipo de Habitación");
        btnTipoHab1.setBackgroundHover(new java.awt.Color(61, 137, 248));
        btnTipoHab1.setFocusPainted(false);
        btnTipoHab1.setFont(new java.awt.Font("Bahnschrift", 0, 16)); // NOI18N
        btnTipoHab1.setHorizontalAlignment(javax.swing.SwingConstants.LEADING);
        btnTipoHab1.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        btnTipoHab1.setIconTextGap(10);
        btnTipoHab1.setIcons(rojeru_san.efectos.ValoresEnum.ICONS.CHEVRON_RIGHT);
        btnTipoHab1.setOpaque(true);
        btnTipoHab1.setRequestFocusEnabled(false);
        btnTipoHab1.setSizeIcon(25.0F);
        btnTipoHab1.setVerifyInputWhenFocusTarget(false);
        btnTipoHab1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnTipoHab1ActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 4;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        modulos.add(btnTipoHab1, gridBagConstraints);
    ...
    private void btnTipoHab1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTipoHab1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_btnTipoHab1ActionPerformed
...
//    }
    ...
    private newscomponents.RSButtonIcon_new btnTipoHab1;
